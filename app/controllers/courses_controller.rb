class CoursesController < ApplicationController
  ...
  def export_course_sections
    ...
    when "2023;FA"
      term_start = DateTime.new(2023, 8, 28, 8, 10, 0)
      term_end = DateTime.new(2023, 12, 15, 22, 0, 0)
    when "2024;SP"
      term_start = DateTime.new(2024, 1, 16, 8, 10, 0)
      term_end = DateTime.new(2024, 5, 10, 22, 0, 0)
    when "2024;FA"
      term_start = DateTime.new(2024, 8, 26, 8, 10, 0)
      term_end = DateTime.new(2024, 12, 13, 22, 0, 0)
    when "2025;SP"
      term_start = DateTime.new(2025, 1, 21, 8, 10, 0)
      term_end = DateTime.new(2025, 5, 16, 22, 0, 0)
    else
